  ...
  <div>
    <div class="header">
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          状态：<el-cascader v-model="search.status" :options="options" :props="props" collapse-tags collapse-tags-tooltip
            clearable placeholder="选择状态" />
        </el-col>
        <el-col :span="8">
      ...
      <el-table-column fixed="right" label="操作" width="120">
        <template #default="scope">
          <el-button link type="primary" size="small"
            @click="() => { drawer = true; detailId = scope.row.id }">详情</el-button>
          <el-button link type="primary" size="small">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <TableDetail :id="detailId" :drawer="drawer" direction="rtl" :showFoot="true" :onChange="onDrawerChange" />
