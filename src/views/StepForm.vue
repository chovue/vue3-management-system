...
<template>
  <div class="step-home-page">
      ...
      <el-form :model="form" label-width="100px" ref="formRef" :rules="rules" label-position="top">
        <div v-show="active === 0">
          ...
          <el-form-item label="转账金额" prop="price">
            <el-input-number v-model="form.price" controls-position="right" :min="1" :max="1000">
            </el-input-number>
          </el-form-item>
        </div>
        <div v-show="active === 1">
          ...
          <el-form-item label="支付密码" prop="name">
            <el-input v-model="form.pass" type="passworld" placeholder="请输入"></el-input>
          </el-form-item>
        </div>
        <div v-show="active === 2">
          <el-result icon="success" title="操作成功" sub-title="预计两小时内到账"></el-result>
          ...
          <el-descriptions title="账单信息" :column="1" border>
            ...
            <el-descriptions-item label="转账金额">500.00元
            </el-descriptions-item>
          </el-descriptions>
        </div>
      </el-form>
    ...
    <div class="foot">
      <el-button v-show="active > 0" style="margin-top: 12px" @click="preview">上一步</el-button>
      <el-button v-show="active !== 2" style="margin-top: 12px" @click="next" type="primary">下一步</el-button>
      <el-button v-show="active === 2" style="margin-top: 12px" @click="submit" type="primary">确定</el-button>
    </div>
