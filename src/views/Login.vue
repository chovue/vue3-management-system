  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <div class="change-btn">
        ...
        <p>已经有账号了？</p>
        <el-button link size="large" @click="show = ShowCase.login"
          >登 录</el-button
        >
      </div>
      ...
      <div class="change-btn">
        ...
        <p>还没有账号?</p>
        <el-button link size="large" @click="show = ShowCase.register"
          >注 册</el-button
        >
      </div>
      ...
      <div class="wrapper" :class="{ move: show === ShowCase.register }">
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" @click="submit(registerFormRef)"
              >注 册</el-button
            >
